  ...
  return (
    <>
      ...
      <motion.aside
        ...
        transition={{ duration: 0.6, delay: 0.8 }}
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex md:hidden items-center gap-1 px-4 py-2 rounded-full bg-card/80 backdrop-blur-md border border-border/50 shadow-lg"
      >
        {socialLinks.map((link, index) => (
          <motion.a
            key={link.name}
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="social-link min-w-[44px] min-h-[44px] flex items-center justify-center"
